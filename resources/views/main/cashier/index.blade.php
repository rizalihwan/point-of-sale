                                ...
                                <div class="mdc-layout-grid__inner">
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                        <div class="mdc-text-field mdc-text-field--outlined">
                                            <input class="mdc-text-field__input" value="{{ $pay->name }}" readonly name="name" required id="text-field-hero-input">
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                        <div class="mdc-text-field mdc-text-field--outlined">
                                            <input class="mdc-text-field__input" name="price" value="{{ $pay->price }}" readonly type="number" required id="price">
                                            <div class="mdc-notched-outline">
                                                <div class="mdc-notched-outline__leading"></div>
                                                <div class="mdc-notched-outline__notch">
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                        <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="mdc-text-field__input" name="stock" value="{{ $pay->stock }}" readonly type="hidden" required id="stock_hidden">
                                        <input class="mdc-text-field__input" name="stock" value="{{ $pay->stock }}" readonly type="number" required id="stock">
                                            <div class="mdc-notched-outline">
                                                <div class="mdc-notched-outline__leading"></div>
                                                <div class="mdc-notched-outline__notch">
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                        <div class="mdc-text-field mdc-text-field--outlined">
                                            <input class="mdc-text-field__input" name="description" readonly value="{{ $pay->description }}" required id="description">
                                            <div class="mdc-notched-outline">
                                                <div class="mdc-notched-outline__leading"></div>
                                                <div class="mdc-notched-outline__notch">
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                        <div class="mdc-text-field mdc-text-field--outlined">
                                            <input class="mdc-text-field__input" name="total" value="0" type="number" required readonly id="total">
                                            <div class="mdc-notched-outline">
                                                <div class="mdc-notched-outline__leading"></div>
                                                <div class="mdc-notched-outline__notch">
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                        <div class="mdc-text-field mdc-text-field--outlined">
                                            <input class="mdc-text-field__input" name="returns" value="0" type="number" required readonly id="returns">
                                            <div class="mdc-notched-outline">
                                                <div class="mdc-notched-outline__leading"></div>
                                                <div class="mdc-notched-outline__notch">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hoverable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>{{ $nomor++.'.' }}</td>
                                                <td>{{ $good->created_at->format('d F, Y') }}</td>
                                                <td>{{ $good->name }}</td>
                                                <td>{{ $good->merk->merk }}</td>
                                                <td>{{ $good->distributor->name }}</td>
                                                <td>{{ $good->price }}</td>
                                                <td>{{ $good->stock }}</td>
                                                <td>{{ $good->description }}</td>
                                                <td><a href="{{ route('menu.cashier.pay',$good->id) }}" class="mdc-button mdc-button--unelevated filled-button--success mdc-ripple-upgraded" style="--mdc-ripple-fg-size:56px; --mdc-ripple-fg-scale:1.969919748761058; --mdc-ripple-fg-translate-start:-26.600006103515625px, -21px; --mdc-ripple-fg-translate-end:18.816665649414062px, -10px;">Pay<i class="material-icons">add</i></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        @endforeach
